  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      if (err.code === 'auth/unauthorized-domain') {
        ...
        setAuthError(`Domain Not Authorized: "${currentHost}" is not listed in Firebase Authorized Domains. To fix this, open Firebase Console > Authentication > Settings > Authorized domains and add "${currentHost}".`);
  ...
  const handleAuthAction = async () => {
    ...
    try {
      ...
      if (error.code === 'auth/unauthorized-domain') {
        const currentHost = typeof window !== 'undefined' ? window.location.hostname : 'your domain';
        message = `Domain Not Authorized: "${currentHost}" is not listed in Firebase Authorized Domains. Add "${currentHost}" in Firebase Console > Authentication > Settings > Authorized domains.`;
        ...
        <div className="w-full max-w-sm flex flex-col items-center">
          ...
          <div className="w-full space-y-4">
            ...
            <button 
              ...
              className="w-full h-16 bg-white text-black border-2 border-black/5 rounded-3xl font-bold uppercase tracking-widest text-[12px] active:scale-[0.98] transition-all hover:bg-black/[0.02] mt-2"
            >
